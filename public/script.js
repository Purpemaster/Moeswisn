...
const radioStations = [
  { stream: "http://bassdrive.com/v2/streams/BassDrive.m3u", icon: "drum_and_bass_icon.png" },
  { stream: "https://icecast.radio.co/s98b27fa6b/listen", icon: "skate_punk_icon.png" },
  { stream: "https://stream.srg-ssr.ch/reggae/mp3_128.m3u", icon: "reggae_icon.png" },
  { stream: "https://stream.laut.fm/oldschool", icon: "hip_hop_icon.png" },
  { stream: "https://stream.laut.fm/gothicrock", icon: "gothic_icon.png" },
  { stream: "https://bootliquor.somafm.com/stream/128", icon: "country_icon.png" },
  { stream: "https://folkforward.somafm.com/stream/128", icon: "folk_music_icon.png" },
  { stream: "https://sonicuniverse.somafm.com/stream/128", icon: "jazz_soul_icon.png" },
